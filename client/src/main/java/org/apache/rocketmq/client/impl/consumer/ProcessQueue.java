...
public class ProcessQueue {
    ...
    /**
     * 读写锁，控制多线程并发修改msgTreeMao、msgTreeMapTemp
     */
    private final ReadWriteLock lockTreeMap = new ReentrantReadWriteLock();

    /**
     * 消息存储同期，键为消息在ConsumeQueue中的偏移量，MessageExt：消息实体
     */
    ...
    /**
     * 将consumingMsgOrderlyTreeMap中所有消息重新放到msgTreeMap并清除consumingMsgOrderlyTreeMap
     */
